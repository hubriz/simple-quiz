    ...
    $.fn.jquizzy = function (settings) {
        ...
        var superContainer = $(this),
           ...
           // introFob = '	<div class="intro-container slide-container"><div class="question-number">' + config.startText + '</div><a class="nav-start" href="#"><img src="' + config.splashImage + '" /></a></div>	',
            introFob = '	<div class="intro-container slide-container"><div class="question-number">' + config.startText + '</div><h1 id="mainTitle">World Record Event</h1><h2 class="title"><span class="title-content">Play It. Learn It. Live It. Help Change the World&#33;</span></h2><button class="nav-start">Start</button></div>	',
        ...
        superContainer.find('.final').click(function () {
            ...
            shareButton = '<a href="http://twitter.com/share?text=' + config.twitterStatus.replace("{score}", score) + '&via=Greatbiblerace" class="share-button"><img src="' + config.twitterImage + '" /></a>';
